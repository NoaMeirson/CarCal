...
MODELS = {
    "NOA_model": Path(r"C:\Users\cs513\Desktop\Evaluation\Damages\Evaluation_results\NOA"),
    "TAL_model": Path(r"C:\Users\cs513\Desktop\Evaluation\Damages\Evaluation_results\TAL"),
    "HAREL2_model": Path(r"C:\Users\cs513\Desktop\Evaluation\Damages\Evaluation_results\HAREL2"),
    "ChatGPT":      Path(r"C:\Users\cs513\Desktop\Evaluation\Damages\Evaluation_results\chatGPT"),
}

OUTPUT_DIR = Path(r"C:\Users\cs513\Desktop\Evaluation\Damages\Evaluation_results\models_comparison_results")
...
def build_validation_table(overall_data):
    ...
    for model_name, df in overall_data.items():
        ...
        rows.append({
            ...
            "GT_instances": source.get(
                "GT_instances",
                np.nan
            ),
            "visual_conf": source.get(
                "visual_conf",
                np.nan
            ),
            "match_mask_iou": source.get(
                "match_mask_iou",
                np.nan
            ),
        })
