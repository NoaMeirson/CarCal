"""Converts OpenAI's structured-output part detections into CarCal's
...
local Mask2Former car-parts model's car_parts_only output.
...
from schema import PART_CLASSES  # noqa: E402
...
def build_detections(raw_detections, width: int, height: int, warn) -> list[Detection]:
    ...
    for i, raw_det in enumerate(raw_detections or []):
        ...
        # Engine/services/car_parts_model_service.convert_car_parts_result_to_detections
